    ...
    <section style={{ maxWidth: "800px", margin: "0 auto 3rem", padding: "0 1rem" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem", marginBottom: "1rem" }}>
        {[
          ...
          { title: "Pre-shift your schedule before departure", detail: "If you have 3–4 days before a major trip, start shifting your bedtime toward the destination time zone. Go to bed 1 hour earlier per day for eastward travel; 1 hour later for westward. Pair this with solid pre-travel sleep hygiene — good practices covered in our <a href='/sleep-hygiene-tips/' style='color:var(--accent-light)'>sleep hygiene tips guide</a> — to reduce the adjustment burden once you arrive." },
        ].map(({ title, detail }) => (
